---
layout: post
title: 'Netatmo Caméra de Surveillance Extérieure Intelligente avec éclairage intégré Presence Sécurité  Détection de Personnes  Voitures et Animaux  Aluminium Noir'
date: 2022-04-05 08:03:33
...
- COMPATIBLE: Amazon Alexa, Apple Homekit, Apple Homekit Secure Video, Google Assistant. Contrôlez la caméra par la voix et créez des scénarios avec d’autres objets connectés. Configuration requise : Réseau Wi-Fi avec connexion Internet à haut débit nécessaire (la vitesse minimale de connexion en amont/aval requise est de 25 KB/s). Les points daccès publics ne sont pas pris en charge. Une version récente dAndroid avec accès à Google Play est recommandée. Pour contrôler cet accessoire compatible HomeKit, la dernière version diOS ou diPadOS est recommandée
