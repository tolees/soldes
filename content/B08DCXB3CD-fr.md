...
- 【Conception de câble améliorée】Pour un confort ultime, ce boîtier NVMe peut désormais être livré avec un tout NOUVEAU câble données 2-en-1 (USB-C vers C + USB-C vers A) au lieu de deux câbles séparés. Vous en recevrez un au hasard, les deux prenant en charge le transfert de données haute vitesse et la charge.
